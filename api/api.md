...
| `Get` | [`GetEndDeviceRequest`](#ttn.lorawan.v3.GetEndDeviceRequest) | [`EndDevice`](#ttn.lorawan.v3.EndDevice) | Get the end device with the given identifiers. To return additional fields, specify them in the field mask. More or less fields may be returned, depending on the rights of the caller. |
