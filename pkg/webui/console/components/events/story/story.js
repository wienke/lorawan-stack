...
storiesOf('Events/Application', module).add('Widget', () => (
  <div style={{ width: '540px' }}>
    <Events.Widget events={events} appId="test-app2" />
  </div>
))
...
storiesOf('Events/Gateway', module).add('Widget', () => (
  <div style={{ width: '540px' }}>
    <Events.Widget events={gatewayEvents} gtwId="test-gtw-id" scoped />
  </div>
))
...
storiesOf('Events/Organization', module).add('Widget', () => (
  <div style={{ width: '540px' }}>
    <Events.Widget events={organizationEvents} orgId="test-org-id" scoped />
  </div>
))
...
storiesOf('Events/Device', module).add('Widget', () => (
  <div style={{ width: '540px' }}>
    <Events.Widget events={deviceEvents} deviceId="test-dev-c" scoped />
  </div>
))
